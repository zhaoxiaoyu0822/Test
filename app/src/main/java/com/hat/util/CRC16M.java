...
/**
 * CRC-16/Modbus   x^16 + x^15 + x^2 + 1   (0x8005)
 * 验证http://www.ip33.com/crc.html
 */
public class CRC16M {

    private static final byte[] crc16_tab_h = {
            0x00, (byte) 0xC1, (byte) 0x81,
    ...
    private static byte[] crc16_tab_l = {(byte) 0x00, (byte) 0xC0, (byte) 0xC1,
    ...
    public static byte[] get(byte[] bytes) {
        ...
        int crc = ((ucCRCHi & 0x00ff) << 8) | (ucCRCLo & 0x00ff) & 0xffff;
        //高低位互换，高位在左，低位在右。输出符合相关工具对Modbus CRC16的运算
